  ...
  function (_Component) {
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (this.props.data !== data || this.props.width !== width || this.props.height !== height || this.props.layout !== layout || this.props.stackOffset !== stackOffset || !(0, _PureRender.shallowEqual)(this.props.margin, margin)) {
