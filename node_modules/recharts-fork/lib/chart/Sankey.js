...
function (_Component) {
  ...
  _createClass(Sankey, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.data !== data || this.props.width !== width || this.props.height !== height || !(0, _PureRender.shallowEqual)(this.props.margin, margin) || this.props.iterations !== iterations || this.props.nodeWidth !== nodeWidth || this.props.nodePadding !== nodePadding || this.props.nameKey !== nameKey) {
